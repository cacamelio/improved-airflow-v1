...
void studio_align_ik_matrix(matrix3x4_t& mMat, const vector3d& vAlignTo) {
...
bool studio_solve_ik(int thigh, int knee, int foot, vector3d& target_foot, vector3d& target_knee_pos, vector3d& target_knee_dir, matrix3x4_t* bone_to_world) {
...
bool studio_solve_ik(int thigh, int knee, int foot, vector3d& target_foot, matrix3x4_t* bone_to_world) {
	auto world_foot = bone_to_world[foot].get_origin();
	auto world_knee = bone_to_world[knee].get_origin();
	auto world_thigh = bone_to_world[thigh].get_origin();
